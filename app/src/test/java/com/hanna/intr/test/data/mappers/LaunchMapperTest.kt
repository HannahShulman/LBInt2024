...
class LaunchMapperTest {
    ...
    @Test
    fun GIVEN_launchResponse_WHEN_mapped_THEN_id_mapped_as_expected() {
    ...
    @Test
    fun GIVEN_launchResponse_WHEN_mapped_THEN_name_mapped_as_expected() {
    ...
    @Test
    fun GIVEN_launchResponse_WHEN_mapped_THEN_date_mapped_as_expected() {
    ...
    @Test
    fun GIVEN_launchResponse_WHEN_mapped_THEN_success_mapped_as_expected() {
    ...
    @Test
    fun GIVEN_launchResponse_with_details_null_WHEN_mapped_THEN_details_mapped_as_expected() {
    ...
    @Test
    fun GIVEN_launchResponse_with_details_empty_WHEN_mapped_THEN_details_mapped_as_expected() {
    ...
    @Test
    fun GIVEN_launchResponse_with_details_not_empty_WHEN_mapped_THEN_details_mapped_as_expected() {
